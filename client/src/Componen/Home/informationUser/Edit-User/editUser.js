...
function EditUserFilveCV (props) {
    const classes = useStyles();
    const rootRef = React.useRef(null);
    const {modal,detailFileCv,updateUser,offModal} = props;
    const [newUserDetail,setNewUserDetail]=useState({})
    useEffect(()=>{
        'name' in detailFileCv && setNewUserDetail(detailFileCv)
    },[detailFileCv]);
    const handleUpdate=(e)=>{
        e.preventDefault()
        let newU=newUserDetail;
        delete newU['id'];
        updateUser(detailFileCv.id,newU)
        offModal(); 
    };
                ...
                <div className="row row--35">
                  ...
                  <div className="userForm-Img" style={margin}>
                    ...
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.name}
                        name="name"
                    ...
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.email}
                        name="email"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />      
                    </div>
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.account}
                        name="account"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />
                    </div>
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.password}
                        type="password"
                        name="password"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />
                  ...
                  <div className="Right-form col-lg-4 col-md-6 col-12 Right-form-user" style={styleRight}>
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.phone}
                        name="phone"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />  
                    </div>
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.birthday}
                        name="birthday"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />
                    </div> 
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        name="experience"
                        defaultValue={detailFileCv.experience}
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />
                    </div>           
                    <RadioGroup className="Register-form" name="sex" name="gender1" value={detailFileCv.sex} onChange={(e)=>handleChange(e.target.name,e.target.value)}>
                        <FormControlLabel
                          control={<Radio />}
                          label="Nam"
                          value="Nam"
                  ...
                  <div className="Right-form col-lg-4 col-md-6 col-12 Right-form-user" style={styleRight}>
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.skill}
                        name="skill"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />
                    </div>
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.foreiginLanguage}
                    ...
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.education}
                        name="education"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />        
                    </div>           
                    <div className="divInput">
                      ...
                      <TextField
                        id="standard-basic"
                        defaultValue={detailFileCv.description}
                        name="description"
                        onChange={(e)=>handleChange(e.target.name,e.target.value)}
                      />
                    </div>
...
export default(EditUserFilveCV);
